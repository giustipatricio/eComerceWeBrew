  ...
  <body>
    ...
    <br>
      <div class="container" id="singin" style="text-align: -webkit-center; padding:0px; margin:0 auto">
        ...
        {{-- //datos personales// --}}
        <form class="form-horizontal" id="singup" action="<?=url("/direccionMod")?>" method="post" enctype="multipart/form-data" >
            {{csrf_field()}}
    ...
    <script type="text/javascript" src="{{ URL::asset('js/index0.js') }}"></script>
