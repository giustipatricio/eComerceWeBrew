...
if($_POST){
  $name = $_POST['name'];
    try {
      $query = $baseDeDatos->prepare ("INSERT INTO segment
        VALUES (default,'$name')");
         $query-> execute();
         // var_dump($query); exit;
...
<html lang="en" dir="ltr">
  ...
  <body>
          ...
          <form class="form-horizontal" id="marcas" >
            <div class="cuadro">
            <div class="titulo" style="text-align-last: center;"><h2>SEGMENTOS CARGADOS</h2></label>
              <table class="table table-sm table-dark conteiner-fluid" >
                ...
                <tbody>
                  <?php  foreach ($segments as $segment):?>
                    <tr>
                      <th scope="row"><?=$segment['segment_id'];?></th>
                      <td><?=$segment['segment_name'];?></td>
                      <td><a href="../AMB/segmentsmod.php?segment_id=<?= $segment["segment_id"] ?>"> <i class="fas fa-file-alt"></i></a></td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
              </table>
          ...
          <form class="form-horizontal" id="amb" action="../AMB/segments.php" method="post" enctype="multipart/form-data">
            <div class="cuadro">
              <div class="titulo" style="text-align-last: center;"><h2>CARGA DE SEGMENTO</h2></label>
